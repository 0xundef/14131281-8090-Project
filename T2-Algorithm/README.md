...
A non-linear data structure consisting of nodes (vertices) and edges. It is used to represent networks, such as social connections, maps, and routing paths.
...
- `main.py`: Implementation of Graph and BFS traversal.
